...
public class Const {
	...
	public static final HashMap<String, Integer> PG_P = new HashMap<>(); // print the result in m(30)
	...
	static {
		...
		PG_P2.put("1155", 0x333f);// JCC cc(3), content of m(31), mean jump to (3)
	...
	public static final HashMap<String, Integer> PG_P1 = new HashMap<>(); // print the result in m(30)
	static {
		// presets of this single program
		...
		PG_P1.put("1055", 0x333f);// JCC cc(3), content of m(31), mean jump to (3)
	...
	static {
		...
		PG1_20.put("301", 0xf3e); // LDA r3 with content of memory address 30 (0)
		...
		PG1_20.put("312", 0x343c);// JMA to c(memory 28) means jump to (2) (1) it is a ','
		...
		PG1_20.put("334", 0x343c);// JMA to c(memory 28) means jump to (3) (2) it is a digit
		...
		PG1_20.put("355", 0x93D);// Store r1 into memory with a location of c(memory 29)
		...
		PG1_20.put("361", 0x343C);// JMA to c(memory 28) means jump to (3) (3)
	...
	static {
		PROG2_0.put("1600", 0xf34); // Load r3 with content of m(20) (0)
	...
	static {
		PROG2_0.put("1700", 0xf33); // Load r3 with content of m(19) (0)
...
static {
	...
	static {
		...
		OPCODE.put("001010", "JSR");
		OPCODE.put("001011", "RFS");
		OPCODE.put("001100", "SOB");
		OPCODE.put("001101", "JGE");

		OPCODE.put("001110", "AMR");
		OPCODE.put("001111", "SMR");
		OPCODE.put("010000", "AIR");
		OPCODE.put("010001", "SIR");

		OPCODE.put("010010", "MLT");
		OPCODE.put("010011", "DVD");
		OPCODE.put("010100", "TRR");
		OPCODE.put("010101", "AND");
		OPCODE.put("010110", "ORR");
		OPCODE.put("010111", "NOT");

		OPCODE.put("011000", "SRC");
		OPCODE.put("011001", "RRC");
